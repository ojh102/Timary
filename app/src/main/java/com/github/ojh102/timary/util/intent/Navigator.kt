package com.github.ojh102.timary.util.intent
...
import com.github.ojh102.timary.util.*
...
class Navigator {
    ...
    companion object {
        ...
        fun navigateToTermTextActivity(context: Context) {
            val title = TimaryResourcesUtil.getString(R.string.term_title)
            val content = TimaryResourcesUtil.getString(R.string.term_content)
